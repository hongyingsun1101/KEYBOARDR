...
#'
#' Unpacks objects returned by other functions with descriptive descriptions of
...
#' @param ... ignored.
#'
#' @return This function is helpful to interpret the objects returned by other
...
#'
#' ## Summarize the object returned by get.oc.comb.kb()
#' p.true <- matrix(c(0.02, 0.04, 0.08, 0.14,
#'                    0.08, 0.25, 0.42, 0.48,
#'                    0.25, 0.45, 0.50, 0.60), byrow=TRUE, ncol=4)
#' oc.comb <- get.oc.comb.kb(target=0.25, p.true, ncohort=16, cohortsize=3,
#'                           ntrial=100)
#' summary.kb(oc.comb)
#'
#'
